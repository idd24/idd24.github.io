experience1 = `
    <h3 class="company-name">Software Engineer @ <a href='https://www.turn14.com/' target="_blank">Turn 14</a>
    ...
    <ul class="compant-desc">
        <li class="company-info">
            Utilized front-end and back-end methodologies to design and develop application features
        </li>
        <li class="company-info">
...
experience2 = `
    <h3 class="company-name">ML Engineer @ <a href='https://corporate.comcast.com/' target="_blank">Comcast</a> 
    <span class="toggle-icon" onclick="toggleExperience()">
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
